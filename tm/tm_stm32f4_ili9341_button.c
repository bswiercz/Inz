...
ErrorStatus TM_ILI9341_Button_Draw(uint8_t id) {
	...
	if ((TM_ILI9341_Buttons[id].flags & TM_BUTTON_FLAG_NOLABEL) == 0) {
		...
		TM_ILI9341_Puts(x, y, TM_ILI9341_Buttons[id].label, TM_ILI9341_Buttons[id].font, TM_ILI9341_Buttons[id].color, /*TM_ILI9341_Buttons[id].background*/ILI9341_COLOR_LGRAY);
	}
	...
	if ((TM_ILI9341_Buttons[id].flags & TM_BUTTON_FLAG_NOBORDER) == 0) {
		...
		TM_ILI9341_DrawRectangle(	TM_ILI9341_Buttons[id].x,
									TM_ILI9341_Buttons[id].y,
									TM_ILI9341_Buttons[id].x + TM_ILI9341_Buttons[id].width-1,
									TM_ILI9341_Buttons[id].y + TM_ILI9341_Buttons[id].height-1,
									ILI9341_COLOR_GRAY );
		TM_ILI9341_DrawLine(	TM_ILI9341_Buttons[id].x,
									TM_ILI9341_Buttons[id].y,
									TM_ILI9341_Buttons[id].x + TM_ILI9341_Buttons[id].width,
									TM_ILI9341_Buttons[id].y,
									ILI9341_COLOR_WHITE );
